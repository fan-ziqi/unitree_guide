#include "control/convexMPC/convexMPC_interface.h"
#include "control/convexMPC/common_types.h"
#include "control/convexMPC/SolverMPC.h"
...
void update_problem_data(double *p, double *v, double *q, double *w, double *r, double yaw, double *weights, double *state_trajectory, double alpha,
                         int *gait)
{
